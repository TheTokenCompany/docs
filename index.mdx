...
|--------|-----|------|---------|
| 10,000 | 97K tok/s | 170K tok/s | 1.8x |
| 100,000 | 259K tok/s | 484K tok/s | 1.9x |
| 500,000 | 416K tok/s | 717K tok/s | 1.7x |
| 1,000,000 | 416K tok/s | 717K tok/s | 1.7x |

With gzip, 100K tokens completes in **~90ms** and 1M tokens in **~920ms**. Throughput scales further with more compressible content (templated prompts, repeated structures).
